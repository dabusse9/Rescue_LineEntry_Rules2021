= RoboCupJunior Rescue Line Entry - Rules 2022
Last update: {docdate}
:toc: macro
:toc-title: Contents
:sectanchors:
...
Line Entry Working Group are the only official rules for RoboCupJunior Rescue Line Entry 2022. The translated versions that can be published by each
